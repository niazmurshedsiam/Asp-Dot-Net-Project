<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Taking_Book.aspx.cs" Inherits="Libary_Management.Taking_Book" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridTaking_Book" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GridTaking_Book_PageIndexChanging" OnRowCancelingEdit="GridTaking_Book_RowCancelingEdit" OnRowDeleting="GridTaking_Book_RowDeleting" OnRowEditing="GridTaking_Book_RowEditing" OnRowUpdating="GridTaking_Book_RowUpdating">
        <Columns>
